...
void hdecom_svd(Eigen::Matrix3d &HH, std::vector<Eigen::Matrix3d> &Rest, std::vector<Eigen::Vector3d> &Test,
                std::vector<Eigen::Vector3d> &Nest);

void hdecom_ding(Eigen::Matrix3d &HH, std::vector<Eigen::Matrix3d> &Rest, std::vector<Eigen::Vector3d> &Test,
                 std::vector<Eigen::Vector3d> &Nest);
