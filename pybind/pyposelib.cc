...
std::pair<FCam, py::dict> estimate_kFk_wrapper(const std::vector<Eigen::Vector2d> points2D_1,
                                               const std::vector<Eigen::Vector2d> points2D_2,
                                               std::vector<double> ks,
                                               bool use_distorted,
                                               bool use_9pt,
    ...
    RansacStats stats = estimate_kFk(points2D_1, points2D_2, ks, use_distorted, use_9pt, ransac_opt, bundle_opt,
                                     &F_cam, &inlier_mask);
