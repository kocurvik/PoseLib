...
int main() {
    ...
    rel_monodepth_shared_focal_shift_4pt_opt.n_point_point_ = 4;
    rel_monodepth_shared_focal_shift_4pt_opt.min_focal_ = 0.1;
    rel_monodepth_shared_focal_shift_4pt_opt.max_focal_ = 5.0;
    rel_monodepth_shared_focal_shift_4pt_opt.unknown_focal_ = true;
    rel_monodepth_shared_focal_shift_4pt_opt.use_monodepth_ = true;
    rel_monodepth_shared_focal_shift_4pt_opt.unknown_shift_ = true;
    results.push_back(poselib::benchmark_relative<poselib::SolverMonodepthSharedFocalShiftRel4pt>(
        1e4, rel_monodepth_shared_focal_shift_4pt_opt, tol));
    ...
    rel_monodepth_varying_focal_shift_4pt_opt.n_point_point_ = 4;
    rel_monodepth_varying_focal_shift_4pt_opt.min_focal_ = 0.1;
    rel_monodepth_varying_focal_shift_4pt_opt.max_focal_ = 5.0;
    rel_monodepth_varying_focal_shift_4pt_opt.unknown_focal_ = true;
    rel_monodepth_varying_focal_shift_4pt_opt.varying_focal_ = true;
    rel_monodepth_varying_focal_shift_4pt_opt.use_monodepth_ = true;
    rel_monodepth_varying_focal_shift_4pt_opt.unknown_shift_ = true;
    results.push_back(poselib::benchmark_relative<poselib::SolverMonodepthVaryingFocalShiftRel4pt>(
        1e4, rel_monodepth_varying_focal_shift_4pt_opt, tol));
