...
bool test_shared_focal_calib_normal_acc() {
    const size_t N = 10;
    std::string camera_str = "0 SIMPLE_PINHOLE 1 1 1.2 0.0 0.0";
    Camera camera;
    camera.initialize_from_txt(camera_str);
    ...
    NormalAccumulator acc;
    CalibSharedFocalRefiner refiner(x1, x2);
    acc.initialize(refiner.num_params);
...
bool test_shared_focal_calib_jacobian() {
    const size_t N = 10;
    std::string camera_str = "0 SIMPLE_PINHOLE 1 1 1.2 0.0 0.0";
    Camera camera;
    camera.initialize_from_txt(camera_str);
    ...
    CalibSharedFocalRefiner<UniformWeightVector, TestAccumulator> refiner(x1, x2);
...
//
bool test_shared_focal_calib_refinement() {
    const size_t N = 10;
    std::string camera_str = "0 SIMPLE_PINHOLE 1 1 1.2 0.0 0.0";
    Camera camera;
    camera.initialize_from_txt(camera_str);
...
bool test_shared_focal_principal_calib_normal_acc() {
    const size_t N = 10;
    std::string camera_str = "0 SIMPLE_PINHOLE 1 1 1.2 0.2 -0.1";
    Camera camera;
    camera.initialize_from_txt(camera_str);
    ...
    NormalAccumulator acc;
    CalibSharedFocalPrincipalRefiner refiner(x1, x2);
    acc.initialize(refiner.num_params);
...
bool test_shared_focal_principal_calib_jacobian() {
    const size_t N = 10;
    std::string camera_str = "0 SIMPLE_PINHOLE 1 1 1.2 0.2 -0.1";
    Camera camera;
    camera.initialize_from_txt(camera_str);
    ...
    CalibSharedFocalPrincipalRefiner<UniformWeightVector, TestAccumulator> refiner(x1, x2);
...
//
bool test_shared_focal_principal_calib_refinement() {
    const size_t N = 10;
    std::string camera_str = "0 SIMPLE_PINHOLE 1 1 1.2 0.2 -0.1";
    Camera camera;
    camera.initialize_from_txt(camera_str);
...
bool test_focal_calib_normal_acc() {
    const size_t N = 10;
    std::string camera_str1 = "0 SIMPLE_PINHOLE 1 1 1.2 0.0 0.0";
    std::string camera_str2 = "0 SIMPLE_PINHOLE 1 1 1.8 0.0 0.0";
    ...
    NormalAccumulator acc;
    CalibFocalRefiner refiner(x1, x2);
    acc.initialize(refiner.num_params);
...
bool test_focal_calib_jacobian() {
    const size_t N = 10;
    std::string camera_str1 = "0 SIMPLE_PINHOLE 1 1 1.2 0.0 0.0";
    std::string camera_str2 = "0 SIMPLE_PINHOLE 1 1 1.8 0.0 0.0";
    Camera camera1, camera2;
    ...
    CalibFocalRefiner<UniformWeightVector, TestAccumulator> refiner(x1, x2);
...
//
bool test_focal_calib_refinement() {
    const size_t N = 10;
    std::string camera_str1 = "0 SIMPLE_PINHOLE 1 1 1.2 0.0 0.0";
    std::string camera_str2 = "0 SIMPLE_PINHOLE 1 1 1.8 0.0 0.0";
    Camera camera1, camera2;
...
bool test_focal_principal_calib_normal_acc() {
    const size_t N = 10;
    std::string camera_str1 = "0 SIMPLE_PINHOLE 1 1 1.2 0.2 -0.06";
    std::string camera_str2 = "0 SIMPLE_PINHOLE 1 1 1.8 -0.1 0.15";
    Camera camera1, camera2;
    camera1.initialize_from_txt(camera_str1);
    camera2.initialize_from_txt(camera_str2);
    ...
    NormalAccumulator acc;
    CalibFocalPrincipalRefiner refiner(x1, x2);
    acc.initialize(refiner.num_params);
...
bool test_focal_principal_calib_jacobian() {
    const size_t N = 10;
    std::string camera_str1 = "0 SIMPLE_PINHOLE 1 1 1.2 0.2 -0.06";
    std::string camera_str2 = "0 SIMPLE_PINHOLE 1 1 1.8 -0.1 0.15";
    Camera camera1, camera2;
    ...
    CalibFocalPrincipalRefiner<UniformWeightVector, TestAccumulator> refiner(x1, x2);
...
//
bool test_focal_principal_calib_refinement() {
    const size_t N = 10;
    std::string camera_str1 = "0 SIMPLE_PINHOLE 1 1 1.2 0.2 -0.06";
    std::string camera_str2 = "0 SIMPLE_PINHOLE 1 1 1.8 -0.1 0.15";
    Camera camera1, camera2;
...
bool test_focal_relpose_normal_acc() {
    const size_t N = 10;
    std::string camera_str1 = "0 SIMPLE_PINHOLE 1 1 1.2 0.0 0.0";
    std::string camera_str2 = "0 SIMPLE_PINHOLE 1 1 1.8 0.0 0.0";
    Camera camera1, camera2;
    ...
    NormalAccumulator acc;
    FocalRelativePoseRefiner refiner(x1, x2);
    acc.initialize(refiner.num_params);
...
bool test_focal_relpose_jacobian() {
    const size_t N = 10;
    std::string camera_str1 = "0 SIMPLE_PINHOLE 1 1 1.2 0.0 0.0";
    std::string camera_str2 = "0 SIMPLE_PINHOLE 1 1 1.8 0.0 0.0";
    Camera camera1, camera2;
    ...
    FocalRelativePoseRefiner<UniformWeightVector, TestAccumulator> refiner(x1, x2);
...
//
bool test_focal_relpose_refinement() {
    const size_t N = 10;
    std::string camera_str1 = "0 SIMPLE_PINHOLE 1 1 1.2 0.0 0.0";
    std::string camera_str2 = "0 SIMPLE_PINHOLE 1 1 1.8 0.0 0.0";
    Camera camera1, camera2;
...
std::vector<Test> register_optim_relative_test() {
    return {TEST(test_relative_pose_normal_acc), TEST(test_relative_pose_jacobian),
            ...
            TEST(test_shared_focal_calib_normal_acc), TEST(test_shared_focal_calib_jacobian),
            TEST(test_shared_focal_calib_refinement), TEST(test_shared_focal_principal_calib_normal_acc),
            TEST(test_shared_focal_principal_calib_jacobian), TEST(test_shared_focal_principal_calib_refinement),
            TEST(test_focal_calib_normal_acc), TEST(test_focal_calib_jacobian), TEST(test_focal_calib_refinement),
            TEST(test_focal_principal_calib_normal_acc), TEST(test_focal_principal_calib_jacobian),
            TEST(test_focal_principal_calib_refinement),
            TEST(test_focal_relpose_normal_acc), TEST(test_focal_relpose_jacobian), TEST(test_focal_relpose_refinement)};
}